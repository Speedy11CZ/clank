...
import net.hashsploit.clank.server.medius.test.packets.MediusAccountRegistrationRequest;
import net.hashsploit.clank.server.medius.test.packets.MediusAccountRegistrationResponse;
